<?php /* Smarty version Smarty-3.1.6, created on 2018-03-12 01:23:46
         compiled from "D:/amp/Apache24/htdocs/likeplus/Home/View\Sale\useradd.html" */ ?>
<?php /*%%SmartyHeaderCode:36315aa55eff451bf4-33078400%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1d42c6ac83b70798680ac23479b438572e47ecdd' => 
    array (
      0 => 'D:/amp/Apache24/htdocs/likeplus/Home/View\\Sale\\useradd.html',
      1 => 1520788898,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '36315aa55eff451bf4-33078400',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5aa55eff51662',
  'variables' => 
  array (
    'salesname' => 0,
    'ware_id' => 0,
...
<?php if ($_valid && !is_callable('content_5aa55eff51662')) {function content_5aa55eff51662($_smarty_tpl) {?><!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8" />
...
/index">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="userinfo.html">用户个人信息</a></li>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <form role="form" onsubmit="return emp()" action="<?php echo @__APP__;?>
/sale/useradd?ware_id=<?php echo $_smarty_tpl->tpl_vars['ware_id']->value;?>
" method="post">
                            <div class="form-group row">
                                <label for="name" class="col-4 col-form-label">姓名</label>
                                <div class="col-8">
                                    <input type="text" required parsley-type="email" class="form-control"
                                           id="name" name="name" placeholder="真实姓名" >
                                </div>
                            </div>
                            <div class="form-group row">
...
assets/js/jquery.app.js"></script>
        ...
        <script type="text/javascript">
            ...
            function emp(){
                //电话不能为空
                var temp0 = document.getElementById("number");//捕获id
                //对电话号进行正则验证
                var myreg0 = /^1[34578]\d{9}$/;
                if(!myreg0.test(temp0.value))
                {
                    alert('提示\n\n请输入有效的电话号码！');
                    return false;
                }
